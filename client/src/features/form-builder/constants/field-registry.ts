...
export interface FieldDefinition {
  ...
  category:
    "basic" | "selection" | "datetime" | "advanced" | "layout" | "special";
...
export const FIELD_REGISTRY: Record<string, FieldDefinition> = {
  ...
  textarea: {
    ...
    icon: AlignLeft,
    category: "basic",
    defaultConfig: { placeholder: "Enter text...", rows: 4 },
  },
  number: {
    type: "number",
    label: "Number",
  ...
  phone: {
    ...
    icon: Phone,
    category: "basic",
    defaultConfig: { placeholder: "+91 9876543210" },
  },
  url: {
    type: "url",
    label: "URL",
  ...
  image: {
    ...
    icon: ImageIcon,
    category: "advanced",
    defaultConfig: { maxSize: 2, acceptedTypes: [".jpg", ".png", ".webp"] },
  },
  signature: {
    type: "signature",
    label: "Signature",
  ...
  repeater: {
    ...
    icon: Repeat,
    category: "special",
    defaultConfig: { fields: [], addButtonLabel: "Add Item" },
  },
  calculation: {
    type: "calculation",
    label: "Calculation",
