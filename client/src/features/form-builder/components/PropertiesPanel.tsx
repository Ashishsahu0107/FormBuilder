...
export function PropertiesPanel({
  ...
  if (!field) {
    if (settings && onUpdateSettings) {
      return (
        <div
          className={`bg-white border-l border-gray-200 flex flex-col h-full ${className}`}
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onUpdateSettings({ successMessage: e.target.value })
                }
                rows={3}
              />
            </div>
            ...
            <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="space-y-0.5">
                ...
                <div className="text-xs text-gray-500">
                  Show each section as a separate page
                </div>
              </div>
              <Switch
                checked={!!settings.isMultiStep}
                onCheckedChange={(c) => onUpdateSettings({ isMultiStep: c })}
              />
            </div>
          </div>
        </div>
    ...
    return (
      <div
        className={`bg-white border-l border-gray-200 p-6 flex items-center justify-center text-center text-sm text-gray-500 ${className}`}
      >
    ...
    >
      <div className="p-4 border-b border-gray-200 bg-gray-50">
        <h3 className="font-semibold text-gray-800 flex items-center gap-2">
          Properties
          <span className="text-xs font-normal text-gray-500 px-2 py-0.5 bg-gray-200 rounded uppercase">
            {field.type}
          </span>
        </h3>
      </div>
                ...
                <div key={i} className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      onUpdate(field.id, {
                        config: { ...field.config, fields: sfArr },
                      });
                    }}
                  />
                  <Button
        ...
        {field.type === "calculation" && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-500 mb-1">
              Use field names in brackets, e.g. [price] * [quantity]
            </div>
            <Input
        ...
        <div className="pt-4 border-t border-gray-200 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(c) => onUpdate(field.id, { hidden: c })}
            />
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {["full", "half", "third"].map((w) => (
                <button
                  ...
                  onClick={() =>
                    onUpdate(field.id, {
                      layout: { ...field.layout, width: w as any },
                    })
                  }
