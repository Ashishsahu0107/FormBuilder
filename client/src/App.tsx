      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/register" element={<RegisterPage />} />`n            <Route path="/forgot-password" element={<ForgotPasswordPage />} />`n
            ...
            <Route path="/template-editor/:templateId" element={<ProtectedRoute><TemplateEditorPage /></ProtectedRoute>} />
