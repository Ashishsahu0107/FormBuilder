        ...
        <Card className="w-full shadow-2xl border-white/10 bg-white/10 backdrop-blur-md text-white">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <motion.div variants={itemVariants} className="space-y-2">
                <Label htmlFor="email" className="text-indigo-50">
                  Email
                </Label>
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label htmlFor="password" className="text-indigo-50">
                    Password
                  </Label>
                  <a
                    href="#"
          ...
          <CardFooter className="justify-center border-t border-white/10 mt-2 pt-6 pb-6">
            <motion.div
              ...
              className="text-sm text-indigo-100/70"
            >
              Don't have an account?{" "}
              <button
                onClick={() => navigate("/register")}
                className="font-semibold text-indigo-300 hover:text-indigo-200 hover:underline transition-colors"
              >
                Create one now
              </button>
            </motion.div>
